class Splash {
  constructor() {
    ...
    this.info = createP(
      "I try to make fast real-time rendering of graphics this time - Shader. I believe some great visuals react to the sound or movements can use shader. Thanks to the GLSL and parallel computing GPU from both of which I learn more. So amazing and appreciate it to be learning from such a skilled teacher like Bryan Jacobs.♥️ And thanks to this class, I realize I do love Generative Art. <p> I could go on and on and on.<p> <a href=https://editor.p5js.org/ytnawmel/sketches/SBa5slNoB>view code</a>"
    );
